...
export class MybetListComponent implements OnInit {
  match_bets: any = [];
  tennis_bets: any = [];
  soccer_bets: any = [];
  session_bets: any = [];
  ...
  getAllBets() {
    forkJoin([
      this.matchBetService.getCloseBetsForMatch(0),
      this.bookmakerBetsService.getCloseBetsForBookmaker(0),
      this.sessionBetsService.getCloseBetsforSession(0),
      this.fancyBetsService.getCloseBetsforFancy(0),
      this.soccerBetService.getCloseBetsforSoccer(0),
      this.tennisBetsService.getCloseBetsforTennis(0),
    ]).subscribe({
